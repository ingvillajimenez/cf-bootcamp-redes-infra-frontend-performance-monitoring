...
NREUM.loader_config = {
  ...
  trustKey: "7352645",
  agentID: "1589158536",
  licenseKey: "NRJS-3cbffc46c41ae051124",
  applicationID: "1589158536",
};
NREUM.info = {
                ...
                return {
                  ...
                  api: {
                    get allow_registered_children() {
                      return (
                        e.feature_flags.includes(a.$v.REGISTER) ||
  ...
  (i.m = r),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self["webpackChunk:NRBA-1.302.0.PROD"] =
          self["webpackChunk:NRBA-1.302.0.PROD"] || []);
    ...
    (() => {
              ...
              const p = (e, t) => {
                ...
                g = (t, r, i) => {
                  ...
                  try {
                    ...
                    return (
                      (!0 === n || Array.isArray(n)) && t(...r, void 0, o),
                      t(...r, i, o)
                    );
                  } catch (e) {
                    (0, l.R)(50, e);
      ...
      class Fe extends E {
        ...
        constructor(e) {
          ...
          try {
            r = JSON.parse(
              localStorage.getItem("".concat(_.H3, "_").concat(_.uh))
            );
          } catch (e) {}
        ...
        #o(e) {
          return (
            (e &&
              (e.sessionReplayMode === _.g.FULL ||
                e.sessionReplayMode === _.g.ERROR)) ||
        ...
        #i() {
          this.blocked ||
            (this.featAggregate
              ? this.featAggregate.mode !== _.g.FULL &&
                this.featAggregate.initializeRecording(_.g.FULL, !0, Ue.Qb.API)
      ...
      class bt extends E {
        ...
        constructor(e) {
          ...
          let a;
          if (
            (y.RI && o && (he(this.ee), oe(this.ee), (a = Oe(this.ee))), y.RI)
          ) {
            if (
              e.init.user_actions.enabled &&
              (vt.Zp.forEach((e) =>
      ...
      new (class extends r {
        ...
        features: [Ee, S, j, De, Fe, k, q, bt, Tt, Ve, mt],
        loaderType: "spa",
      });
    })();
})();
